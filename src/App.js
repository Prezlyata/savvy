...
import AddPartnerFormContainer from './components/AddPartnerForm/AddPartnerFormContainer';
	...
	return (
		<React.Fragment>
			...
			<Switch>
				...
				<Route exact path="/partners/addPartner" component={AddPartnerFormContainer} />
